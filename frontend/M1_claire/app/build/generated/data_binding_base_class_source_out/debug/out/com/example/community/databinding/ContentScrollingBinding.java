...
public final class ContentScrollingBinding implements ViewBinding {
  ...
  private ContentScrollingBinding(@NonNull ConstraintLayout rootView, @NonNull ListView chatList) {
  ...
  public static ContentScrollingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.chat_list;
      ListView chatList = ViewBindings.findChildViewById(rootView, id);
      if (chatList == null) {
        break missingId;
      }

      return new ContentScrollingBinding((ConstraintLayout) rootView, chatList);
    }
