...
class Model extends IModel {
    ...
    async trainModel() {
        ...
        const offerRes = await axios.get('http://http://ec2-35-183-145-212.ca-central-1.compute.amazonaws.com:3000/communityPost/offers');
        ...
        const requestRes = await axios.get('http://http://ec2-35-183-145-212.ca-central-1.compute.amazonaws.com:3000/communityPost/requests');
